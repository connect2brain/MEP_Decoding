...
load('/proj/bioem/exampledata/cbusample/samplehead_cbu.mat',...
    'bmeshes', 'eegsens', 'megsens', 'sources');%bmeshes, eegsens, megsens, sources
...
% configured%If new meshes, perform some checks...
...
[LFMphi_dir,LFMb_dir]=hbf_LFM_LC(bmeshes,coils,Tphi_elecs,TBvol,sourcepos,sourcedir);
%   forward solutions for xyz-oriented triplets
[LFMphi_xyz,LFMb_xyz]=hbf_LFM_LC(bmeshes,coils,Tphi_elecs,TBvol,sourcepos);
